...
import styles from './PersonalInfo.module.css'; // Create this CSS module
...
function PersonalInfo() {
    return (
        <div className={styles.container}>
            ...
            <div className={styles.imageLabels}>
                <ImageLabel alt='fblogo' h={25} w={25} imgUrl={fblogo} text='Facebook' br={'50%'} mb={5} ml={15} mr={15} />
                <ImageLabel alt='tiktoklogo' h={25} w={25} imgUrl={tiktoklogo} text='TikTok' br={'50%'} mb={5} ml={15} mr={15} />
                <ImageLabel alt='instalogo' h={25} w={25} imgUrl={instaLogo} text='Instagram' br={'50%'} mb={5} ml={15} mr={15} />
            </div>
            <span className={styles.sectionTitle}>Packages</span>
            <div className={styles.textLabels}>
